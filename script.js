...
//   document.getElementById('totalBox').innerText = '生産数ﾄﾞﾛｯﾌﾟﾀﾞｳﾝ: ' + total1;
  ...
  // 合計値を赤い四角に表示
if (total6 === 0) {
    document.getElementById('totalBox').style.backgroundColor = 'green';
    document.getElementById('totalBox').style.color = 'white';
    document.getElementById('totalBox').innerText = '運転中';
} else {
    document.getElementById('totalBox').style.backgroundColor = 'red';
    document.getElementById('totalBox').style.color = 'white';
    document.getElementById('totalBox').innerText = '停止中';
}
